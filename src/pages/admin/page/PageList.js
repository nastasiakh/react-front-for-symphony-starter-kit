...
import Pagination from "../../../components/base_elements/Pagination";
      ...
      <div className="d-flex col-10 flex-column container position-relative">
        ...
        <div className="mb-4">
          <div className="d-flex col-2">
            <Link className="app-button" to={"/pages/create"}>
              Add
            </Link>
          </div>
        </div>
          ...
          <table className="d-flex col-12 u-full-width flex-column">
            ...
            <tbody>
              {Array.isArray(pages) && pages.length ? (
                  ...
                  <tr className="d-flex justify-content-between p-2 align-items-center mb-1">
                    ...
                    <td className="d-flex justify-content-between ">
                      <Link
                        ...
                        className="app-button action-button caution"
                      >
                ...
                <h3
                  className="d-flex justify-content-center heading mt-5"
                  style={{ color: "#d0d0d0" }}
                >
                  List is empty
                </h3>
